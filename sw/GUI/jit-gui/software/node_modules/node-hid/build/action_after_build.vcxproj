...
<Project DefaultTargets="Build" ToolsVersion="14.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <PropertyGroup Label="Globals">
    <ProjectGuid>{326663D3-B8F7-0D9E-A647-F0FA885A345A}</ProjectGuid>
  ...
  <ItemDefinitionGroup Condition="'$(Configuration)|$(Platform)'=='Debug|x64'">
    <ClCompile>
      <AdditionalIncludeDirectories>C:\Users\Steve.Clark\.node-gyp\0.35.4\include\node;C:\Users\Steve.Clark\.node-gyp\0.35.4\src;C:\Users\Steve.Clark\.node-gyp\0.35.4\deps\uv\include;C:\Users\Steve.Clark\.node-gyp\0.35.4\deps\v8\include;%(AdditionalIncludeDirectories)</AdditionalIncludeDirectories>
    ...
    <Link>
      <AdditionalDependencies>kernel32.lib;user32.lib;gdi32.lib;winspool.lib;comdlg32.lib;advapi32.lib;shell32.lib;ole32.lib;oleaut32.lib;uuid.lib;odbc32.lib;DelayImp.lib;&quot;C:\Users\Steve.Clark\.node-gyp\0.35.4\$(Configuration)\node.lib&quot;</AdditionalDependencies>
  ...
  <ItemGroup>
    <CustomBuild Include="$(OutDir)\HID.node">
      <FileType>Document</FileType>
      <Command>call mkdir &quot;..\build\HID\v0.5.1\Release\node-v46-win32-x64&quot; 2&gt;nul &amp; set ERRORLEVEL=0 &amp; copy /Y &quot;$(OutDir)HID.node&quot; &quot;..\build\HID\v0.5.1\Release\node-v46-win32-x64\HID.node&quot;&#xD;&#xA;if %errorlevel% neq 0 exit /b %errorlevel%</Command>
      <Message>Copying $(OutDir)/HID.node to ./build/HID/v0.5.1/Release/node-v46-win32-x64/HID.node</Message>
      <Outputs>..\build\HID\v0.5.1\Release\node-v46-win32-x64\HID.node</Outputs>
    </CustomBuild>
  </ItemGroup>
  <ItemGroup>
    <ProjectReference Include="HID.vcxproj">
      <Project>{D06BD8C6-DE8F-3F4F-D79A-5337B0C4CA78}</Project>
