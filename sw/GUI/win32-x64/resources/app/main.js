...
var template = [
  ...
  },
  {
    ...
    submenu: [
      {
        label: 'Insight on Things README',
        click: function() {
          shell.openExternal('https://github.com/MicrochipTech/aws-iot-insight-on-things-desktop-app/blob/master/README.md');}
      },
      {
...
app.on('ready', function() {
  ...
  mainWindow = new BrowserWindow({width: 600 , height: 650, resizable: true});
